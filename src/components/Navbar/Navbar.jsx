...
const Navbar = () => {
  ...
  return (
   <nav>
    ...
    {
      menu && (
       <ul className='gap-6 justify-start flex flex-col md:hidden bg-white z-20 h-[100vh] w-[50%] fixed left-0 top-0 py-4 transition-transform duration-300 ease-in-out'>
         <Link to='/'>
