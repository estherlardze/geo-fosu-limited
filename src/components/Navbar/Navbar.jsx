   ...
   <nav>
    <div className='p-4 sm:p-8 flex justify-end'>
      <ul className='hidden sm:flex text-white font-bold uppercase gap-6 justify-end '>
       <Link to='/'>
         <li className={`${changeBg} py-[2px] px-4 cursor-pointer hover:bg-transparent transition-all ease-in duration-300`}> Home </li>
        </Link>
        <Link to='/about'>
         <li className={`${changeBg} py-[2px] px-4 cursor-pointer hover:bg-transparent transition-all ease-in duration-300`}>About</li>
        </Link>
        <Link to='/projects'>
         <li className={`${changeBg} py-[2px] px-4 cursor-pointer hover:bg-transparent transition-all ease-in duration-300`}> Projects</li>
         </Link> 
         <Link to='/contact'>
          <li className={`${changeBg} py-[2px] px-4 cursor-pointer hover:bg-transparent transition-all ease-in duration-300`}>Contact </li>
        </Link>
      </ul>   
