...
const ConstructionText = () => {
  return (
    ...
    <div className='mt-[50px] text-black/90 text-lg font-semibold' data-aos="fade-up">
      ...
      <h4 className='text-orange text-left font-bold mb-1' data-aos="fade-up">Goal</h4>
      <p className='mb-3' data-aos="fade-up">
       To be a leader in fostering sustainable development through innovative
      ...
      <h4 className='text-orange text-left font-bold mb-1' data-aos="fade-up">Slogan</h4>
      <p className='mb-3' data-aos="fade-up">Building Dreams, Nurturing Knowledge, Managing Excellence.</p>

      <h4 className='text-orange text-left font-bold mb-1' data-aos="fade-up">Vision</h4>
      <p className='mb-3' data-aos="fade-up">
      To be a pioneering force in construction innovation, a beacon of academic
       excellence, and the epitome of project management proficiency.</p>
     
      <h4 className='text-orange text-left font-bold mb-1' data-aos="fade-up">Our Missions</h4>
       <p data-aos="fade-up"> Our mission is to deliver superior building construction services, foster academic growth
      ...
      <div className='text-black/90 text-lg font-semibold'>
        ...
        <div className='text-lg mt-8'>
          <h4 className='text-orange text-left mb-1 font-bold' data-aos="fade-up">Our Objectives</h4>
          <div>
          {objectives.map((objective, index) => (
            <div key={index} className='my-2 font-bold' data-aos="fade-up">
              <p >{objective.title}</p>
