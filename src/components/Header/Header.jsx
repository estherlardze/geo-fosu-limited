  ...
  return (
    <header className='w-[90%] mx-[5%] md:w-[80%] md:mx-[10%] mt-[60px]'>
      <div className='flex gap-6 items-start sm:items-center'>
        <img src={Logo} alt="logo" className='w-[80px] h-[80px] bg-white rounded-full'/>
      ...
      <h4 className='uppercase text-lg sm:text-xl md:text-2xl font-semibold text-white mt-[30px]'>
        Building dreams, nurturing knowledge, <br />managing excellence
      </h4>
      <div className='flex mt-6'>
        <button className='text-white bg-orange-500 py-1 px-6 font-semibold rounded-l-full'>Search</button>
